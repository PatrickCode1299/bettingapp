...
if(isset($_POST['search'])){
	$ticketref=$_POST['ticketid'];
    require 'db.php';
$fetchinfo="SELECT DISTINCT unique_id, gameowner,gamerefid,gamedate,gameamount,winningamount,oddamount FROM usersgameholder WHERE gamerefid='$ticketref' AND gameamount !=''";
